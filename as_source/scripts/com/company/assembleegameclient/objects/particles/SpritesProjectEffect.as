package com.company.assembleegameclient.objects.particles
{
   ...
   public class SpritesProjectEffect extends ParticleEffect
   {
      ...
      private function parseBitmapDataFromImageSet() : void
      {
         ...
         var _loc1_:ImageSet = AssetLibrary.getImageSet("lofiparticlesMusicNotes");
         var _loc3_:uint = 9;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            images.push(TextureRedrawer.redraw(_loc1_.images_[_loc2_],this.particleScale,true,16764736,true));
            _loc2_++;
         }
      }
      ...
      private function onTimer(param1:TimerEvent) : void
      {
         ...
         if(map_)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               this.radians = _loc3_ * 2 * Math.PI / _loc2_;
