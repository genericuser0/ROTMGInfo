package com.greensock.easing
{
   public class Ease
   {
      ...
      public function getRatio(param1:Number) : Number
      {
         ...
         _loc2_ = _type == 1?Number(1 - param1):_type == 2?Number(param1):param1 < 0.5?Number(param1 * 2):Number((1 - param1) * 2);
         if(_power == 1)
         {
         ...
         return _type == 1?Number(1 - _loc2_):_type == 2?Number(_loc2_):param1 < 0.5?Number(_loc2_ / 2):Number(1 - _loc2_ / 2);
      }
   }
}
