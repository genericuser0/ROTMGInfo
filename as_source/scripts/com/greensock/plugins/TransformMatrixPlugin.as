package com.greensock.plugins
{
   ...
   public class TransformMatrixPlugin extends TweenPlugin
   {
      ...
      override public function _onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         if("x" in param2)
         {
            _txChange = typeof param2.x == "number"?Number(param2.x - _txStart):Number(Number(param2.x.split("=").join("")));
         }
         ...
         if("y" in param2)
         {
            _tyChange = typeof param2.y == "number"?Number(param2.y - _tyStart):Number(Number(param2.y.split("=").join("")));
         }
         ...
         _aChange = "a" in param2?Number(param2.a - _aStart):Number(0);
         _bChange = "b" in param2?Number(param2.b - _bStart):Number(0);
         _cChange = "c" in param2?Number(param2.c - _cStart):Number(0);
         _dChange = "d" in param2?Number(param2.d - _dStart):Number(0);
         if("rotation" in param2 || "shortRotation" in param2 || "scale" in param2 && !(param2 is Matrix) || "scaleX" in param2 || "scaleY" in param2 || "skewX" in param2 || "skewY" in param2 || "skewX2" in param2 || "skewY2" in param2)
         {
            ...
            if(_loc7_ == 0)
            {
               _loc4_.a = _loc7_ = 0.0001;
            }
            else if(_loc4_.a < 0 && _loc4_.d > 0)
            {
               _loc7_ = -_loc7_;
            }
            ...
            if(_loc8_ == 0)
            {
               _loc4_.d = _loc8_ = 0.0001;
            }
            else if(_loc4_.d < 0 && _loc4_.a > 0)
            {
               _loc8_ = -_loc8_;
            }
            ...
            {
               _loc11_ = typeof param2.rotation == "number"?Number(param2.rotation * _DEG2RAD):Number(Number(param2.rotation.split("=").join("")) * _DEG2RAD + _loc9_);
            }
            _loc12_ = "skewX" in param2?typeof param2.skewX == "number"?Number(Number(param2.skewX) * _DEG2RAD):Number(Number(param2.skewX.split("=").join("")) * _DEG2RAD + _loc10_):Number(0);
            if("skewY" in param2)
            {
               _loc14_ = typeof param2.skewY == "number"?Number(param2.skewY * _DEG2RAD):Number(Number(param2.skewY.split("=").join("")) * _DEG2RAD - _loc10_);
