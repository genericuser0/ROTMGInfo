package io.decagames.rotmg.pets.popup.evolving
{
   ...
   public class PetEvolvingDialog extends ModalPopup
   {
      ...
      {
         var _loc3_:String = ObjectLibrary.getIdFromType(param1);
         var _loc4_:XML = ObjectLibrary.getXMLfromId(_loc3_);
         var _loc5_:String = _loc4_.AnimatedTexture.File;
         var _loc6_:int = _loc4_.AnimatedTexture.Index;
         var _loc7_:AnimatedChar = AnimatedChars.getAnimatedChar(_loc5_,_loc6_);
         var _loc8_:MaskedImage = _loc7_.imageFromAngle(0,AnimatedChar.STAND,0);
         var _loc9_:BitmapData = TextureRedrawer.resize(_loc8_.image_,_loc8_.mask_,param2,true,0,0);
         _loc9_ = GlowRedrawer.outlineGlow(_loc9_,0,6);
         return new Bitmap(_loc9_);
      }
   }
}
