package io.decagames.rotmg.pets.popup.hatching
{
   ...
   public class PetHatchingDialog extends ModalPopup
   {
      ...
      {
         var _loc1_:String = ObjectLibrary.getIdFromType(this._petSkin);
         ...
         var _loc7_:BitmapData = TextureRedrawer.resize(_loc6_.image_,_loc6_.mask_,this.eggSize,true,0,0);
