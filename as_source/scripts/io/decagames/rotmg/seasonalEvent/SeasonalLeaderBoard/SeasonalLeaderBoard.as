package io.decagames.rotmg.seasonalEvent.SeasonalLeaderBoard
{
   ...
   public class SeasonalLeaderBoard extends UIPopup
   {
      ...
      private function createError() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this._error,14,16711680,TextFormatAlign.CENTER,true);
      ...
      private function createRefreshTime() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this._refreshTime,12,16777215,TextFormatAlign.CENTER,true);
      ...
      private function createLastUpdatedTime() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this._lastUpdatedTime,12,16777215,TextFormatAlign.CENTER,true);
      ...
      private function createTab(param1:String, param2:Sprite, param3:UIGrid) : UITab
      {
         ...
         var _loc5_:int = 384;
         var _loc6_:UIScrollbar = new UIScrollbar(_loc5_);
         _loc6_.mouseRollSpeedFactor = 1;
         _loc6_.scrollObject = _loc4_;
         ...
         _loc7_.graphics.drawRect(0,0,WIDTH,_loc5_);
         _loc7_.x = param2.x;
         _loc7_.y = param2.y;
         param2.mask = _loc7_;
         this._tabContent.addChild(_loc7_);
         _loc4_.addContent(this._tabContent);
         return _loc4_;
      }
