package io.decagames.rotmg.shop.mysteryBox.contentPopup
{
   ...
   public class UIItemContainerMediator extends Mediator
   {
      ...
      override public function initialize() : void
      {
         ...
         var _loc2_:int = ObjectLibrary.idToType_[int(this.view.itemId)];
         this.tooltip = new EquipmentToolTip(int(this.view.itemId),_loc1_,_loc2_,InventoryOwnerTypes.CURRENT_PLAYER);
