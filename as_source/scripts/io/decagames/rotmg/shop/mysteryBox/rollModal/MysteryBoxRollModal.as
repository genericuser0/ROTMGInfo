package io.decagames.rotmg.shop.mysteryBox.rollModal
{
   ...
   public class MysteryBoxRollModal extends ModalPopup
   {
      ...
      public function displayResult(param1:Array) : void
      {
         ...
         {
            var _loc1_:UIItemContainer = null;
            var _loc2_:int = 0;
            for each(_loc1_ in elements)
            {
               _loc2_ = elements.indexOf(_loc1_);
               animateGridElement(_loc1_,_loc2_ * movingDelay,_loc2_ == elements.length - 1);
            }
         };
      ...
      public function displayItems(param1:Array) : Vector.<UIItemContainer>
      {
         ...
         var _loc4_:* = null;
         var _loc5_:UIItemContainer = null;
         var _loc6_:int = 0;
         ...
         for each(_loc3_ in param1)
         {
            ...
            {
               _loc5_ = new UIItemContainer(int(_loc4_),0,0,this.iconSize);
               _loc6_ = _loc3_[_loc4_];
               if(_loc6_ > 1)
               {
                  _loc5_.showQuantityLabel(_loc6_);
               }
               _loc5_.showTooltip = false;
               _loc2_.push(_loc5_);
               this.rollGrid.addGridElement(_loc5_);
            }
         }
