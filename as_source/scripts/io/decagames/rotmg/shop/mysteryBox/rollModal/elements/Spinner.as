package io.decagames.rotmg.shop.mysteryBox.rollModal.elements
{
   ...
   public class Spinner extends Sprite
   {
      ...
      {
         var _loc1_:RandomColorGenerator = new RandomColorGenerator();
         var _loc2_:Array = _loc1_.randomColor();
         var _loc3_:Array = _loc1_.randomColor();
         this.rStart = _loc2_[0];
         this.gStart = _loc2_[1];
         this.bStart = _loc2_[2];
         this.rFinal = _loc3_[0];
         this.gFinal = _loc3_[1];
         this.bFinal = _loc3_[2];
      }
