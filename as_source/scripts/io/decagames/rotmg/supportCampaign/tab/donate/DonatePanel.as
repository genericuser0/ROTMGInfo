package io.decagames.rotmg.supportCampaign.tab.donate
{
   ...
   public class DonatePanel extends Sprite
   {
      ...
      private function createCompleteTextField() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this.completeTextfield,18,65280,TextFormatAlign.CENTER,true);
      ...
      public function addDonateAmount(param1:int) : void
      {
         ...
         if(_loc2_.toString().length > SupporterCampaignModel.DONATE_MAX_INPUT_CHARS || _loc2_ <= 0)
         {
            return;
         }
      ...
      private function updatePoints(param1:int) : void
      {
         ...
         var _loc2_:int = 4;
         var _loc3_:int = this.pointAmountTextfield.width + this.supportIcon.width + _loc2_;
