package io.decagames.rotmg.ui.sliceScaling
{
   ...
   public class SliceScalingBitmap extends Bitmap
   {
      ...
      private function prepare9grid() : void
      {
         ...
         var _loc4_:BitmapData = new BitmapData(this.currentWidth + this.margin.x,this.currentHeight + this.margin.y,true,0);
         var _loc5_:Array = [0,this.scaleGrid.top,this.scaleGrid.bottom,this.bitmapDataToSlice.height];
         var _loc6_:Array = [0,this.scaleGrid.left,this.scaleGrid.right,this.bitmapDataToSlice.width];
         var _loc7_:Array = [0,this.scaleGrid.top,this.currentHeight - (this.bitmapDataToSlice.height - this.scaleGrid.bottom),this.currentHeight];
         var _loc8_:Array = [0,this.scaleGrid.left,this.currentWidth - (this.bitmapDataToSlice.width - this.scaleGrid.right),this.currentWidth];
         var _loc9_:int = 0;
         while(_loc9_ < 3)
         {
            _loc10_ = 0;
            while(_loc10_ < 3)
            {
               _loc1_.setTo(_loc6_[_loc9_],_loc5_[_loc10_],_loc6_[_loc9_ + 1] - _loc6_[_loc9_],_loc5_[_loc10_ + 1] - _loc5_[_loc10_]);
               _loc2_.setTo(_loc8_[_loc9_],_loc7_[_loc10_],_loc8_[_loc9_ + 1] - _loc8_[_loc9_],_loc7_[_loc10_ + 1] - _loc7_[_loc10_]);
               _loc3_.identity();
               _loc3_.a = _loc2_.width / _loc1_.width;
               _loc3_.d = _loc2_.height / _loc1_.height;
               _loc3_.tx = _loc2_.x - _loc1_.x * _loc3_.a;
               _loc3_.ty = _loc2_.y - _loc1_.y * _loc3_.d;
               _loc4_.draw(this.bitmapDataToSlice,_loc3_,null,null,_loc2_);
               _loc10_++;
            }
            _loc9_++;
         }
