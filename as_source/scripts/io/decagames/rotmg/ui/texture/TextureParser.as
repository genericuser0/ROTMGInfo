package io.decagames.rotmg.ui.texture
{
   ...
   public class TextureParser
   {
      ...
      {
         var _loc4_:Bitmap = this.getTexture(param1,param2);
         var _loc5_:Object = this.textures[param1].sliceRectangles.slices[param2 + ".png"];
         var _loc6_:Rectangle = null;
         var _loc7_:String = SliceScalingBitmap.SCALE_TYPE_NONE;
         if(_loc5_)
         {
            _loc6_ = new Rectangle(_loc5_.rectangle.x,_loc5_.rectangle.y,_loc5_.rectangle.w,_loc5_.rectangle.h);
            _loc7_ = _loc5_.type;
         }
         var _loc8_:SliceScalingBitmap = new SliceScalingBitmap(_loc4_.bitmapData,_loc7_,_loc6_);
