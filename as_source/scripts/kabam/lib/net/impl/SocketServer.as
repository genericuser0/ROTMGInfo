package kabam.lib.net.impl
{
   ...
   public class SocketServer
   {
      ...
      {
         var _loc2_:String = this.parseString("Socket-Server Security: {0}. Please open port " + Parameters.PORT + " in your firewall and/or router settings and try again",[param1.text]);
         this.error.dispatch(_loc2_);
         this.closed.dispatch();
      }
