package kabam.rotmg.dailyLogin.controller
{
   ...
   public class CalendarViewMediator extends Mediator
   {
      ...
      private function onClaimReward(param1:ClaimDailyRewardResponse) : void
      {
         ...
         {
            _loc2_ = "gold";
            this.addTextLine.dispatch(ChatMessage.make(Parameters.SERVER_CHAT_NAME,(param1.gold > 0?param1.gold:param1.quantity) + "x " + _loc2_ + " was claimed.",-1,-1,"",false));
         ...
         else
         {
            ...
            this.addTextLine.dispatch(ChatMessage.make(Parameters.SERVER_CHAT_NAME,(param1.gold > 0?param1.gold:param1.quantity) + "x " + _loc2_ + " was claimed and will be sent to the gift chests in your vault.",-1,-1,"",false));
         }
      }
   }
}
