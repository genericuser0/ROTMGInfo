package kabam.rotmg.dailyLogin.view
{
   ...
   public class DailyLoginModal extends Sprite
   {
      ...
      public function showLegend(param1:Boolean) : void
      {
         ...
         var _loc7_:BitmapData = AssetLibrary.getImageFromSet("lofiInterfaceBig",11);
         _loc7_ = TextureRedrawer.redraw(_loc7_,20,true,0);
         _loc8_ = new Bitmap(_loc7_);
         _loc8_.x = -Math.round(_loc8_.width / 2) + 10;
         _loc8_.y = -Math.round(_loc8_.height / 2) + 30;
