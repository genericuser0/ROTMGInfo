package com.company.assembleegameclient.objects.particles
{
   ...
   public class SnowflakeEffect extends ParticleEffect
   {
      ...
      private function run(param1:int, param2:int, param3:int) : Boolean
      {
         ...
         var _loc4_:Number = this.minRad_ + Math.random() * (this.maxRad_ - this.minRad_);
         var _loc5_:int = 0;
         while(_loc5_ < param3)
         {
            _loc6_ = ColorUtil.rangeRandomSmart(this.color1_,this.color2_);
            _loc7_ = _loc5_ * 2 * Math.PI / param3;
            _loc8_ = new SnowflakeParticle(size_,_loc6_,this.maxLife_,_loc7_,_loc4_,true);
