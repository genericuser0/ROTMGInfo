package com.company.assembleegameclient.objects.particles
{
   ...
   public class ThunderEffect extends ParticleEffect
   {
      ...
      private static function parseBitmapDataFromImageSet(param1:uint, param2:String, param3:uint = 0) : Vector.<BitmapData>
      {
         ...
         var _loc5_:ImageSet = AssetLibrary.getImageSet(param2);
         var _loc7_:uint = param1;
         _loc6_ = 0;
         while(_loc6_ < _loc7_)
         {
            _loc8_ = TextureRedrawer.redraw(_loc5_.images_[_loc6_],120,true,16768115,true,5,16768115,1.4);
            if(param3 != 0)
            {
               _loc8_ = applyColorTransform(_loc8_,param3);
            }
            _loc4_.push(_loc8_);
            _loc6_++;
         }
