package com.company.assembleegameclient.screens
{
   ...
   public class LeagueItem extends Sprite
   {
      ...
      private function createText() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this._titleLabel,24,16777215,TextFormatAlign.CENTER,true);
         this._titleLabel.text = this._leagueData.title;
         this._titleLabel.x = (this._panelBackground.width - this._titleLabel.width) / 2;
         this._titleLabel.y = !!this._leagueData.endDate?Number(this._character.y + this._character.height):Number(this._character.y + this._character.height + 10);
         addChild(this._titleLabel);
         if(this._endDate)
         {
            this._timeLabel = new UILabel();
            DefaultLabelFormat.createLabelFormat(this._timeLabel,14,16684800,TextFormatAlign.CENTER);
            addChild(this._timeLabel);
         }
         if(this._leagueData.maxCharacters != -1)
         {
            this._maxCharacters = new UILabel();
            DefaultLabelFormat.createLabelFormat(this._maxCharacters,16,16684800,TextFormatAlign.CENTER,true);
         ...
         DefaultLabelFormat.createLabelFormat(this._descriptionLabel,16,16777215,TextFormatAlign.CENTER);
         ...
         if(this._leagueData.quote != "")
         {
            ...
            DefaultLabelFormat.createLabelFormat(this._quoteLabel,14,13421772,TextFormatAlign.CENTER);
