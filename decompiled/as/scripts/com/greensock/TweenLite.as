      ...
      protected function _initProps(param1:Object, param2:Object, param3:Array, param4:Object) : Boolean
      {
         ...
         for(_loc6_ in _loc5_)
         {
            ...
            else
            {
               ...
               _firstPT.s = !_firstPT.f?Number(Number(param1[_loc6_])):Number(param1[_loc6_.indexOf("set") || !("get" + _loc6_.substr(3) in param1)?_loc6_:"get" + _loc6_.substr(3)]());
               _firstPT.c = typeof _loc10_ === "number"?Number(Number(_loc10_) - _firstPT.s):typeof _loc10_ === "string" && _loc10_.charAt(1) === "="?Number(int(_loc10_.charAt(0) + "1") * Number(_loc10_.substr(2))):Number(Number(_loc10_)) || Number(0);
            }
         }
         if(param4)
         {
