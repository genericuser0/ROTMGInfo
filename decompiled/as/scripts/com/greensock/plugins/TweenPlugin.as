package com.greensock.plugins
{
   ...
   public class TweenPlugin
   {
      ...
      {
         var _loc7_:Number = param4 == null?Number(0):typeof param4 === "number" || param4.charAt(1) !== "="?Number(Number(param4) - param3):Number(int(param4.charAt(0) + "1") * Number(param4.substr(2)));
         if(_loc7_ !== 0)
         {
