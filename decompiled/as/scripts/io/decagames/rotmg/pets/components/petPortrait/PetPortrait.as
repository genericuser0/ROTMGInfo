package io.decagames.rotmg.pets.components.petPortrait
{
   ...
   public class PetPortrait extends Sprite
   {
      ...
      {
         var _loc1_:IconButtonFactory = null;
      ...
      private function getMaxPointsFromAbilitiesList() : int
      {
         ...
         var _loc1_:int = 0;
         for each(_loc2_ in this._petVO.abilityList)
         {
            if(_loc2_.getUnlocked())
            {
               _loc1_ = _loc1_ + AbilitiesUtil.abilityPowerToMinPoints(this._petVO.maxAbilityPower);
            }
         }
         return _loc1_;
      }
