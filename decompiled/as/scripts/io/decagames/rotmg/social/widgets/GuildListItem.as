package io.decagames.rotmg.social.widgets
{
   ...
   public class GuildListItem extends BaseListItem
   {
      ...
      private function createButtons() : void
      {
         ...
         var _loc5_:* = null;
         var _loc1_:int = !!this._isMe?255:205;
         this.guildRank = addButton("lofiInterfaceBig",GuildUtil.getRankIconIdByRank(this._guildMemberRank),_loc1_,12,GuildUtil.rankToString(this._guildMemberRank));
         if(!this._isMe)
         {
            ...
            _loc4_ = !!Parameters.data_.preferredServer?Parameters.data_.preferredServer:Parameters.data_.bestServer;
            _loc5_ = "Your friend is playing on server: " + _loc3_ + ". " + "Clicking this will take you to this server.";
            this.teleportButton = addButton("lofiInterface2",3,230,12,TextKey.FRIEND_TELEPORT_TITLE,_loc5_);
         ...
         var _loc2_:String = !!this._isMe?"Leave Guild":"Remove member";
         this.removeButton = addButton("lofiInterfaceBig",12,280,12,_loc2_);
         if(!this._isMe)
         {
