package kabam.rotmg.ui.view
{
   ...
   public class StatMetersView extends Sprite
   {
      ...
      {
         super();
         this.expBar_ = new StatusBar(176,16,5931045,5526612,TextKey.EXP_BAR_LEVEL,false,true);
         this.fameBar_ = new StatusBar(176,16,14835456,5526612,TextKey.CURRENCY_FAME,false,true);
