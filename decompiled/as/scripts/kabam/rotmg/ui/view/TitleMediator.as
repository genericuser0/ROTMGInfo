package kabam.rotmg.ui.view
{
   ...
   public class TitleMediator extends Mediator
   {
      ...
      private function openSupportPage() : void
      {
         ...
         _loc1_.url = "https://support.decagames.com";
      ...
      private function onSupportVerifyComplete(param1:Boolean, param2:*) : void
      {
         ...
         if(param1)
         {
            ...
            if(_loc3_.hasOwnProperty("mp") && _loc3_.hasOwnProperty("sg"))
            {
               this.toSupportPage(_loc3_.mp,_loc3_.sg);
            }
         }
      }
      ...
      private function toSupportPage(param1:String, param2:String) : void
      {
         ...
         var _loc6_:String = this.playerModel.getSalesForceData();
         if(_loc6_ == "unavailable" || !_loc5_)
         {
            _loc4_.url = "https://decagames.desk.com/customer/authentication/multipass/callback";
         ...
         else if(Capabilities.playerType == "PlugIn" || Capabilities.playerType == "ActiveX")
         {
            ...
            {
               ExternalInterface.call("openSalesForceFirstTime",_loc6_);
