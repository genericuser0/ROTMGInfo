package com.company.assembleegameclient.screens
{
   ...
   public class CharacterTypeSelectionMediator extends Mediator
   {
      ...
      private function logGameMode() : void
      {
         ...
         _loc2_.gameMode = !!this.seasonalEventModel.isChallenger?"Challenger":"Legacy";
         _loc2_.seasonID = this.seasonalEventModel.seasonTitle;
         _loc1_.sendRequest("/log/logGameModePlayed",_loc2_);
      }
