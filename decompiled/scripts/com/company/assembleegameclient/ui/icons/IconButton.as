package com.company.assembleegameclient.ui.icons
{
   ...
   public class IconButton extends Sprite implements TooltipAble
   {
      ...
      private function getCroppedBitmapData(param1:BitmapData, param2:int) : BitmapData
      {
         ...
         var _loc3_:Rectangle = new Rectangle(0,param2,param1.width,param1.height - param2);
         var _loc4_:BitmapData = new BitmapData(param1.width,param1.height - param2);
         _loc4_.copyPixels(param1,_loc3_,new Point(0,0));
         return _loc4_;
      }
