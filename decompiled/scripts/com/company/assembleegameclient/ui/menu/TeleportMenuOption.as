package com.company.assembleegameclient.ui.menu
{
   ...
   public class TeleportMenuOption extends MenuOption
   {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         if(_loc2_ > 0)
         {
            _loc3_ = _loc2_ <= Player.MS_BETWEEN_TELEPORT?int(Player.MS_BETWEEN_TELEPORT):int(Player.MS_REALM_TELEPORT);
            ...
            _loc4_ = this.barTextOrigWidth_ * (1 - _loc2_ / _loc3_);
            this.barMask.width = _loc4_;
