package com.company.assembleegameclient.ui.tooltip
{
   ...
   public class ClassToolTip extends ToolTip
   {
      ...
      {
         var _loc1_:Boolean = Boolean(StaticInjectorContext.injector.getInstance(SeasonalEventModel).isChallenger);
      ...
      {
         var _loc1_:AnimatedChar = AnimatedChars.getAnimatedChar(String(this._playerXML.AnimatedTexture.File),int(this._playerXML.AnimatedTexture.Index));
         var _loc2_:MaskedImage = _loc1_.imageFromDir(AnimatedChar.RIGHT,AnimatedChar.STAND,0);
         var _loc3_:int = 4 / _loc2_.width() * 100;
         var _loc4_:BitmapData = TextureRedrawer.redraw(_loc2_.image_,_loc3_,true,0);
         if(this.showUnlockRequirements)
         {
            _loc4_ = CachingColorTransformer.transformBitmapData(_loc4_,new ColorTransform(0,0,0,0.5,0,0,0,0));
         }
         this.portrait_ = new Bitmap();
         this.portrait_.bitmapData = _loc4_;
         this.portrait_.x = -4;
         this.portrait_.y = -4;
      ...
      private function createEquipmentTypes() : void
      {
         ...
         var _loc1_:Vector.<int> = ConversionUtil.toIntVector(this._playerXML.SlotTypes);
         var _loc2_:Vector.<int> = ConversionUtil.toIntVector(this._playerXML.Equipment);
         var _loc3_:int = 0;
         while(_loc3_ < EquipmentUtil.NUM_SLOTS)
         {
            _loc4_ = _loc2_[_loc3_];
            if(_loc4_ > -1)
            {
               _loc5_ = ObjectLibrary.getRedrawnTextureFromType(_loc4_,40,true);
            ...
            {
               _loc7_ = EquipmentUtil.getEquipmentBackground(_loc1_[_loc3_],2);
               if(_loc7_)
               {
                  _loc7_.x = 12 + _loc3_ * 22;
                  _loc7_.filters = FilterUtil.getDarkGreyColorFilter();
      ...
      private function createStarProgress() : void
      {
         ...
         var _loc12_:UILabel = null;
         var _loc13_:int = 0;
         this._progressContainer = new Sprite();
         var _loc1_:Graphics = this._progressContainer.graphics;
         addChild(this._progressContainer);
         var _loc2_:int = 0;
         var _loc3_:Vector.<int> = FameUtil.STARS;
         var _loc4_:int = _loc3_.length;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = this._charStats != null?int(this._charStats.bestFame()):0;
            _loc8_ = _loc7_ >= _loc6_?Number(65280):Number(16549442);
            _loc9_ = _loc5_ < this._numberOfStars;
            _loc10_ = 20 + _loc5_ * 10;
            _loc11_ = new StarGraphic();
            _loc11_.x = _loc2_ + (_loc10_ - _loc11_.width) / 2;
            _loc11_.transform.colorTransform = !!_loc9_?FULL_STAR:EMPTY_STAR;
            this._progressContainer.addChild(_loc11_);
            _loc12_ = new UILabel();
            _loc12_.text = _loc6_.toString();
            DefaultLabelFormat.characterToolTipLabel(_loc12_,_loc8_);
            _loc12_.x = _loc2_ + (_loc10_ - _loc12_.width) / 2;
            _loc12_.y = 14;
            this._progressContainer.addChild(_loc12_);
            _loc1_.beginFill(1842204);
            _loc1_.drawRect(_loc2_,31,_loc10_,4);
            if(_loc7_ > 0)
            {
               _loc1_.beginFill(_loc8_);
               if(_loc7_ >= _loc6_)
               {
                  _loc1_.drawRect(_loc2_,31,_loc10_,4);
               }
               ...
               {
                  _loc13_ = _loc7_ / _loc6_ * _loc10_;
                  _loc1_.drawRect(_loc2_,31,_loc13_,4);
               }
               else if(_loc7_ > _loc3_[_loc5_ - 1])
               {
                  _loc13_ = (_loc7_ - _loc3_[_loc5_ - 1]) / (_loc6_ - _loc3_[_loc5_ - 1]) * _loc10_;
                  _loc1_.drawRect(_loc2_,31,_loc13_,4);
               }
            }
            _loc2_ = _loc2_ + (1 + _loc10_);
            _loc5_++;
         }
      }
      ...
      private function createBestLevelAndFame() : void
      {
         ...
         _loc2_.text = (this._charStats != null?this._charStats.bestLevel():0).toString();
         DefaultLabelFormat.characterToolTipLabel(_loc2_,16777215);
         _loc2_.x = CLASS_TOOL_TIP_WIDTH - 24;
         ...
         var _loc4_:BitmapData = AssetLibrary.getImageFromSet("lofiObj3",224);
         _loc4_ = TextureRedrawer.redraw(_loc4_,40,true,0);
         var _loc5_:Bitmap = new Bitmap(_loc4_);
         _loc5_.x = CLASS_TOOL_TIP_WIDTH - 36;
         _loc5_.y = _loc3_.y - 10;
         this._bestContainer.addChild(_loc5_);
         ...
         _loc6_.x = _loc5_.x - _loc6_.width;
         _loc6_.y = _loc3_.y;
      ...
      private function createClassUnlocks() : void
      {
         ...
         var _loc1_:int = ObjectLibrary.playerChars_.length;
         var _loc2_:Vector.<XML> = ObjectLibrary.playerChars_;
         var _loc3_:String = this._playerXML.@id;
         var _loc4_:int = this._charStats != null?int(this._charStats.bestLevel()):0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         while(_loc6_ < _loc1_)
         {
            ...
            _loc8_ = _loc7_.@id;
            if(_loc3_ != _loc8_ && _loc7_.UnlockLevel)
            {
               for each(_loc9_ in _loc7_.UnlockLevel)
               {
                  if(_loc3_ == _loc9_.toString())
                  {
                     _loc10_ = int(_loc9_.@level);
                     _loc11_ = _loc4_ >= _loc10_?Number(65280):Number(16711680);
                     _loc12_ = new UILabel();
                     _loc12_.text = "Reach level " + _loc10_.toString() + " to unlock " + _loc8_;
                     DefaultLabelFormat.characterToolTipLabel(_loc12_,_loc11_);
                     _loc12_.y = _loc5_;
                     this._classUnlockContainer.addChild(_loc12_);
                     _loc5_ = _loc5_ + 14;
                  }
               }
            }
      ...
      private function createUnlockRequirements() : void
      {
         ...
         for each(_loc2_ in this._playerXML.UnlockLevel)
         {
            _loc3_ = ObjectLibrary.idToType_[_loc2_.toString()];
            _loc4_ = int(_loc2_.@level);
            if(this._playerModel.getBestLevel(_loc3_) < int(_loc2_.@level))
            {
               _loc1_.pushParams(TextKey.TO_UNLOCK_REACH_LEVEL,{
                  "unlockLevel":_loc4_,
                  "typeToDisplay":ObjectLibrary.typeToDisplayId_[_loc3_]
               });
            }
         }
         this.unlockText_.setStringBuilder(_loc1_);
