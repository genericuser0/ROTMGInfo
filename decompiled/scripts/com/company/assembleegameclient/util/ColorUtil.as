package com.company.assembleegameclient.util
{
   public class ColorUtil
   {
      ...
      public static function rangeRandomSmart(param1:uint, param2:uint) : Number
      {
         ...
         var _loc9_:uint = _loc6_ + Math.random() * (_loc3_ - _loc6_);
         var _loc10_:uint = _loc7_ + Math.random() * (_loc4_ - _loc7_);
         var _loc11_:uint = _loc8_ + Math.random() * (_loc5_ - _loc8_);
      ...
      public static function rangeRandomMix(param1:uint, param2:uint) : Number
      {
         ...
         var _loc10_:uint = _loc6_ + _loc9_ * (_loc3_ - _loc6_);
         var _loc11_:uint = _loc7_ + _loc9_ * (_loc4_ - _loc7_);
         var _loc12_:uint = _loc8_ + _loc9_ * (_loc5_ - _loc8_);
