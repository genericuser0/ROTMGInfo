package com.greensock
{
   ...
   public class TimelineLite extends SimpleTimeline
   {
      ...
      {
         var _loc4_:Number = param1._timeline._totalTime;
         if(param2 != null || !_forcingPlayhead)
         {
            param1._timeline.pause(param1._startTime);
      ...
      public function getTweensOf(param1:Object, param2:Boolean = true) : Array
      {
         ...
         while(--_loc7_ > -1)
         {
            if(_loc6_[_loc7_].timeline === this || param2 && _contains(_loc6_[_loc7_]))
            {
      ...
      public function shiftChildren(param1:Number, param2:Boolean = false, param3:Number = 0) : *
      {
         ...
         if(param2)
         {
            for(_loc5_ in _labels)
            {
               ...
               {
                  _labels[_loc5_] = _labels[_loc5_] + param1;
               }
            }
         }
         _uncache(true);
      ...
      {
         return param1 in _labels?Number(Number(_labels[param1])):Number(-1);
      }
      ...
      protected function _parseTimeOrLabel(param1:*, param2:* = 0, param3:Boolean = false, param4:Object = null) : Number
      {
         ...
         if(typeof param1 === "string" && (isNaN(param1) || param1 in _labels))
         {
            ...
            if(_loc5_ === -1)
            {
               ...
               {
                  return !!param3?Number(_labels[param1] = duration() + param2):Number(param2);
               }
      ...
      override public function totalTime(param1:Number = NaN, param2:Boolean = false, param3:Boolean = false) : *
      {
         _forcingPlayhead = true;
         var _loc5_:* = super.totalTime.apply(this,arguments);
      ...
      {
         return totalTime(typeof param1 === "number"?Number(Number(param1)):Number(_parseTimeOrLabel(param1)),param2);
      }
      ...
      override public function _kill(param1:Object = null, param2:Object = null) : Boolean
      {
         ...
         var _loc3_:Array = param2 == null?getChildren(true,true,false):getTweensOf(param2);
