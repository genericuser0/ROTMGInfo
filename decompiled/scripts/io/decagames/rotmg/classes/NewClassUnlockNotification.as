package io.decagames.rotmg.classes
{
   ...
   public class NewClassUnlockNotification extends Sprite
   {
      ...
      private function createCharacter() : void
      {
         ...
         var _loc2_:int = this._objectTypes.shift();
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_)
         {
            _loc3_ = ObjectLibrary.playerChars_[_loc4_];
            _loc5_ = int(_loc3_.@type);
            if(_loc2_ == _loc5_)
            {
      ...
      private function createCharacterBackground() : void
      {
         ...
         _loc1_.graphics.drawRect(0,0,105,105);
         _loc1_.x = (this.WIDTH - _loc1_.width) / 2;
         _loc1_.y = (this.HEIGHT - _loc1_.height) / 2 - 6;
         this._contentContainer.addChild(_loc1_);
         _loc2_ = TextureParser.instance.getSliceScalingBitmap("UI","popup_background_decoration");
         _loc2_.width = 105;
         _loc2_.height = 105;
         _loc2_.x = _loc1_.x;
         _loc2_.y = _loc1_.y;
      ...
      {
         var _loc2_:BitmapData = SavedCharacter.getImage(null,param1,AnimatedChar.DOWN,AnimatedChar.STAND,0,true,false);
         return _loc2_;
      }
      ...
      private function createClassUnlockLabel() : void
      {
         ...
         _loc1_ = new UILabel();
         _loc1_.text = this.NEW_CLASS_UNLOCKED;
         DefaultLabelFormat.notificationLabel(_loc1_,18,65280,TextAlign.CENTER,true);
         _loc1_.width = this.WIDTH;
         _loc1_.x = (this.WIDTH - _loc1_.width) / 2;
         _loc1_.y = this.HEIGHT - _loc1_.height - 12;
         this._contentContainer.addChild(_loc1_);
      }
