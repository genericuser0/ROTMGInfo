   ...
   public class QuestFetchCompleteCommand extends Command
   {
      ...
      override public function execute() : void
      {
         ...
         if(this.response.quests)
         {
            ...
            for each(_loc1_ in this.response.quests)
            {
               _loc2_ = new DailyQuest();
               _loc2_.id = _loc1_.id;
               _loc2_.name = _loc1_.name;
               _loc2_.description = _loc1_.description;
               _loc2_.expiration = _loc1_.expiration;
               _loc2_.requirements = _loc1_.requirements;
               _loc2_.rewards = _loc1_.rewards;
               _loc2_.completed = _loc1_.completed;
               _loc2_.category = _loc1_.category;
               _loc2_.itemOfChoice = _loc1_.itemOfChoice;
               _loc2_.repeatable = _loc1_.repeatable;
               _loc2_.weight = _loc1_.weight;
               this._questsList.push(_loc2_);
            }
