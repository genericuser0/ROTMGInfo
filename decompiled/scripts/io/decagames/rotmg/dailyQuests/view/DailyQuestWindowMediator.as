package io.decagames.rotmg.dailyQuests.view
{
   ...
   public class DailyQuestWindowMediator extends Mediator
   {
      ...
      {
         if(param1 == DailyQuestsList.EVENT_TAB_LABEL)
         {
      ...
      private function buyRefreshToolTip() : IconToolTip
      {
         ...
         var _loc2_:IconToolTip = new IconToolTip("Refresh Daily Quests",_loc1_,3552822,1,10197915,1,true,new Bitmap(IconFactory.makeCoin()));
         return _loc2_;
      }
      ...
      private function onRedeemComplete(param1:QuestRedeemResponse) : void
      {
         ...
         var message:QuestRedeemResponse = param1;
         try
         {
            if(message.ok)
            {
               ...
               completedQuests++;
               this.view.hideFade();
               this.view.showFade(1381653,completedQuests == this.dailyQuestsModel.numberOfActiveQuests);
