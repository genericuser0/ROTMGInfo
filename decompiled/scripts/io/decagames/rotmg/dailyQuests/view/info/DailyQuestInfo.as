package io.decagames.rotmg.dailyQuests.view.info
{
   ...
   public class DailyQuestInfo extends Sprite
   {
      ...
      public static function hasAllItems(param1:Vector.<int>, param2:Vector.<int>) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc3_:Vector.<int> = param1.concat();
      ...
      private function createQuestAvailable() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this.questAvailable,12,10724259,TextFormatAlign.CENTER,true);
      ...
      private function createRefreshInfo() : void
      {
         ...
         DefaultLabelFormat.createLabelFormat(this.refreshInfo,12,65280,TextFormatAlign.CENTER,true);
      ...
      {
         var _loc1_:DailyQuestItemSlot = null;
      ...
      private function showQuestsCompleteInfo(param1:Boolean, param2:Boolean = true) : void
      {
         ...
         this.rewardsChoice.visible = !!param2?!param1:Boolean(param1);
         this.rewardsTitle.visible = !!param2?!param1:Boolean(param1);
         this.contentDivider.visible = !!param2?!param1:Boolean(param1);
         this.contentDividerTitle.visible = !!param2?!param1:Boolean(param1);
         this._completeButton.visible = !!param2?!param1:Boolean(param1);
      }
      ...
      public function show(param1:DailyQuest, param2:Vector.<int>) : void
      {
         ...
         SlotsRendered.renderSlots(param1.requirements,this._playerEquipment,DailyQuestItemSlotType.REQUIREMENT,this.requirementsContainer,this.requirementsTopMargin,this.slotMargin,INFO_WIDTH,this.slots);
         SlotsRendered.renderSlots(param1.rewards,this._playerEquipment,DailyQuestItemSlotType.REWARD,this.rewardsContainer,this.rewardsTopMargin,this.slotMargin,INFO_WIDTH,this.slots,param1.itemOfChoice);
