package io.decagames.rotmg.dailyQuests.view.list
{
   ...
   public class DailyQuestListElement extends Sprite
   {
      ...
      private function setElements() : void
      {
         ...
         DefaultLabelFormat.questNameListLabel(this.questNameTextfield,this._category == 7?uint(2201331):this._completed || this._isSelected?uint(16777215):uint(13619151));
