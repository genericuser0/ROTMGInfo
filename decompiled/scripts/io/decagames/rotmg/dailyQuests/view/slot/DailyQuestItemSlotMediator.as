package io.decagames.rotmg.dailyQuests.view.slot
{
   ...
   public class DailyQuestItemSlotMediator extends Mediator
   {
      ...
      {
         var _loc1_:Player = this.hud.gameSprite && this.hud.gameSprite.map?this.hud.gameSprite.map.player_:null;
         var _loc2_:int = ObjectLibrary.idToType_[this.view.itemID];
         this.tooltip = new EquipmentToolTip(this.view.itemID,this.view.type == DailyQuestItemSlotType.REQUIREMENT?null:_loc1_,_loc2_,InventoryOwnerTypes.CURRENT_PLAYER);
