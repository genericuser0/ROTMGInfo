package io.decagames.rotmg.fame
{
   ...
   public class FameContentPopupMediator extends Mediator
   {
      ...
      override public function initialize() : void
      {
         ...
         {
            _loc2_ = new DateFormatter();
            _loc2_.formatString = "MMMM DD, YYYY";
      ...
      public function getTotalDungeonCompleted() : int
      {
         ...
         while(_loc2_ <= 52)
         {
            _loc1_ = _loc1_ + this.metrics.getCharacterStat(this.characterID,_loc2_);
            _loc2_++;
         }
         return this.metrics.getCharacterStat(this.characterID,MetricsID.PIRATE_CAVES_COMPLETED) + this.metrics.getCharacterStat(this.characterID,MetricsID.UNDEAD_LAIRS_COMPLETED) + this.metrics.getCharacterStat(this.characterID,MetricsID.ABYSS_OF_DEMONS_COMPLETED) + this.metrics.getCharacterStat(this.characterID,MetricsID.SNAKE_PITS_COMPLETED) + this.metrics.getCharacterStat(this.characterID,MetricsID.SPIDER_DENS_COMPLETED) + this.metrics.getCharacterStat(this.characterID,MetricsID.SPRITE_WORLDS_COMPLETED) + _loc1_;
      }
      ...
      private function showCompletedDungeons() : void
      {
         ...
         _loc1_.push(new DungeonLine("Pirate Cave","Pirate Cave",this.metrics.getCharacterStat(this.characterID,MetricsID.PIRATE_CAVES_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Undead Lair","Undead Lair",this.metrics.getCharacterStat(this.characterID,MetricsID.UNDEAD_LAIRS_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Abyss of Demons","Abyss of Demons",this.metrics.getCharacterStat(this.characterID,MetricsID.ABYSS_OF_DEMONS_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Snake Pit","Snake Pit",this.metrics.getCharacterStat(this.characterID,MetricsID.SNAKE_PITS_COMPLETED) + ""));
         ...
         _loc1_.push(new DungeonLine("Lair of Draconis","Lair of Draconis",this.metrics.getCharacterStat(this.characterID,MetricsID.LAIR_OF_DRACONIS_COMPLETED) + this.metrics.getCharacterStat(this.characterID,MetricsID.LAIR_OF_DRACONIS_HM_COMPLETED) + ""));
         ...
         _loc1_.push(new DungeonLine("Puppet Master\'s Theatre","Puppet Master\'s Theatre",this.metrics.getCharacterStat(this.characterID,MetricsID.PUPPET_MASTER_COMPLETED) + ""));
         ...
         _loc1_.push(new DungeonLine("The Nest","The Nest",this.metrics.getCharacterStat(this.characterID,MetricsID.THE_NEST_COMPLETED) + ""));
         ...
         _loc1_.push(new DungeonLine("Cultist Hideout","Cultist Hideout",this.metrics.getCharacterStat(this.characterID,MetricsID.CULTIST_HIDEOUT_COMPLETED) + ""));
         ...
         _loc1_.push(new DungeonLine("Parasite Chambers","Parasite Chambers",this.metrics.getCharacterStat(this.characterID,MetricsID.PARASITE_CHAMBERS_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Magic Woods","Magic Woods",this.metrics.getCharacterStat(this.characterID,MetricsID.MAGIC_WOODS_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Cnidarian Reef","Cnidarian Reef",this.metrics.getCharacterStat(this.characterID,MetricsID.CNIDARIAN_REEF_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Secluded Thicket","Secluded Thicket",this.metrics.getCharacterStat(this.characterID,MetricsID.SECLUDED_THICKETS_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Cursed Library","Cursed Library",this.metrics.getCharacterStat(this.characterID,MetricsID.CURSED_LIBRARIES_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Fungal Cavern","Fungal Cavern",this.metrics.getCharacterStat(this.characterID,MetricsID.FUNGAL_CAVERNS_COMPLETED) + ""));
         _loc1_.push(new DungeonLine("Crystal Cavern","Crystal Cavern",this.metrics.getCharacterStat(this.characterID,MetricsID.CRYSTAL_CAVERNS_COMPLETED) + ""));
