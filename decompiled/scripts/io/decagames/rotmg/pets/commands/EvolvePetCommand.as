package io.decagames.rotmg.pets.commands
{
   ...
   public class EvolvePetCommand extends Command
   {
      ...
      {
         var _loc1_:SkinVO = this.model.getSkinVOById(this.evolvePetInfo.finalPet.skinType);
         var _loc2_:Boolean = _loc1_.isOwned;
         this.model.unlockSkin(this.evolvePetInfo.finalPet.skinType);
         this.openDialog.dispatch(new PetEvolvingDialog(this.evolvePetInfo,_loc2_));
      }
   }
}
