package io.decagames.rotmg.pets.popup.info
{
   ...
   public class PetsTooltip extends ToolTip
   {
      ...
      private function createTable() : void
      {
         ...
         _loc1_.text = "1st Ability";
         _loc1_.x = 80;
         _loc1_.y = 0;
         var _loc2_:UILabel = new UILabel();
         DefaultLabelFormat.infoTooltipText(_loc2_,6539085);
         this.tableContainer.addChild(_loc2_);
         _loc2_.text = "2nd Ability";
         _loc2_.x = 80;
         _loc2_.y = _loc1_.y + _loc1_.height - 4;
         _loc3_ = new UILabel();
         ...
         DefaultLabelFormat.infoTooltipText(_loc5_,5082311);
         this.tableContainer.addChild(_loc5_);
         _loc5_.text = "Evolution";
         _loc5_.x = 80;
         _loc5_.y = _loc4_.y + _loc4_.height - 4;
