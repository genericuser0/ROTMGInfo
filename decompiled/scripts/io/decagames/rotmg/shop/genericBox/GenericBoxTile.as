package io.decagames.rotmg.shop.genericBox
{
   ...
   public class GenericBoxTile extends UIGridElement
   {
      ...
      {
         var _loc1_:ShopBoxTag = this.getTagByName(ShopBoxTag.LEFT_TAG);
         if(_loc1_)
         {
      ...
      private function createBoxTags() : void
      {
         ...
         var _loc1_:Array = this._boxInfo.tags.split(",");
      ...
      {
         var _loc1_:int = this._boxInfo.unitsLeft == -1?int(int.MAX_VALUE):int(this._boxInfo.unitsLeft);
         var _loc2_:int = this._boxInfo.purchaseLeft == -1?int(int.MAX_VALUE):int(this._boxInfo.purchaseLeft);
         return Math.min(_loc1_,_loc2_);
      }
      
      private function clearTagContainer() : void
      {
         var _loc3_:ShopBoxTag = null;
         ...
         var _loc1_:int = this.tags.length;
