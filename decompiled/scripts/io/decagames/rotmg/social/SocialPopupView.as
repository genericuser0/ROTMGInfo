package io.decagames.rotmg.social
{
   ...
   public class SocialPopupView extends ModalPopup
   {
      ...
      public function addGuildDefaultMessage(param1:String) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.x = (350 - 300) / 2 - 20;
         DefaultLabelFormat.guildInfoLabel(_loc3_,14,11776947,TextFormatAlign.CENTER);
         _loc2_.addChild(_loc3_);
         this.guildsGrid.addGridElement(_loc2_);
      }
      ...
      private function addTabs() : void
      {
         ...
         this._tabs.addTab(this.createTab(FRIEND_TAB_LABEL,_loc1_,this.friendsGrid,true),true);
         var _loc2_:Sprite = new Sprite();
         this._tabs.addTab(this.createTab(GUILD_TAB_LABEL,_loc2_,this.guildsGrid),false);
         this._tabs.y = 6;
         this._tabs.x = 0;
         addChild(this._tabs);
      }
      ...
      private function createContentTabs() : void
      {
         ...
         _loc1_ = TextureParser.instance.getSliceScalingBitmap("UI","tab_inset_content_background",350);
         _loc1_.height = 45;
         _loc1_.x = 0;
         _loc1_.y = 5;
         addChild(_loc1_);
      ...
      {
         var _loc1_:SliceScalingButton = new SliceScalingButton(TextureParser.instance.getSliceScalingBitmap("UI","add_button"));
         return _loc1_;
      }
      ...
      private function createTab(param1:String, param2:Sprite, param3:UIGrid, param4:Boolean = false) : UITab
      {
         ...
         var _loc6_:int = !!param4?410:375;
         var _loc7_:UIScrollbar = new UIScrollbar(_loc6_);
         _loc7_.mouseRollSpeedFactor = 1;
         _loc7_.scrollObject = _loc5_;
         _loc7_.content = param2;
         _loc7_.x = this.contentInset.x + this.contentInset.width - 25;
         _loc7_.y = param2.y;
         this._tabContent.addChild(_loc7_);
         _loc8_ = new Sprite();
         _loc8_.graphics.beginFill(0);
         _loc8_.graphics.drawRect(0,0,350,_loc6_ - 5);
         _loc8_.x = param2.x;
         _loc8_.y = param2.y;
         param2.mask = _loc8_;
      ...
      private function createSearchAndAdd() : void
      {
         ...
         var _loc1_:SliceScalingBitmap = this.createSearchInset(296);
         _loc1_.x = this.addButton.x + this.addButton.width;
         _loc1_.y = 10;
         this._tabContent.addChild(_loc1_);
         _loc2_ = this.createSearchIcon();
         _loc2_.x = _loc1_.x;
         _loc2_.y = 5;
         this._tabContent.addChild(_loc2_);
         ...
         this.search.x = _loc2_.x + _loc2_.width - 5;
