package io.decagames.rotmg.supportCampaign.tab
{
   ...
   public class SupporterShopTabView extends UITab
   {
      ...
      public function updatePoints(param1:int, param2:int) : void
      {
         ...
         this.pointsInfo.text = !!param1?param1.toString():"0";
      ...
      private function showUnlockScreen(param1:Boolean, param2:int, param3:int, param4:Boolean, param5:DisplayObject) : void
      {
         ...
         _loc6_.text = "Welcome to the " + this._campaignTitle + ", " + this.pName + "!";
         DefaultLabelFormat.createLabelFormat(_loc6_,18,15395562,TextFormatAlign.LEFT,true);
         _loc6_.wordWrap = true;
         _loc6_.width = param5.width - 20;
         _loc6_.x = 10;
         _loc6_.y = param5.height + 10;
         this.unlockScreenContainer.addChild(_loc6_);
         var _loc7_:UILabel = new UILabel();
         _loc7_.text = this._campaignDescription;
         DefaultLabelFormat.createLabelFormat(_loc7_,14,15395562,TextFormatAlign.JUSTIFY,false);
         ...
         var _loc8_:SliceScalingBitmap = new TextureParser().getSliceScalingBitmap("UI","main_button_decoration_dark",150);
         this.unlockScreenContainer.addChild(_loc8_);
         this._unlockButton = new ShopBuyButton(param2);
         this._unlockButton.width = _loc8_.width - 48;
         this._unlockButton.disabled = !param1 || param4;
         this.unlockScreenContainer.addChild(this._unlockButton);
         _loc8_.x = Math.round((param5.width - _loc8_.width) / 2);
         _loc8_.y = _loc7_.y + _loc7_.height;
         this._unlockButton.x = _loc8_.x + 24;
         this._unlockButton.y = _loc8_.y + 6;
         if(!param1)
         {
         ...
         this._campaignTimer.y = this._countdown.y = _loc6_.y - 20;
