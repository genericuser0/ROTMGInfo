package io.decagames.rotmg.ui
{
   ...
   public class ProgressBar extends UIGridElement
   {
      ...
      private function render(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         var _loc6_:String = this._dynamicLabelString.replace(DYNAMIC_LABEL_TOKEN,!!_loc4_?param2:param1);
         this._dynamicLabel.text = _loc6_.replace(MAX_VALUE_TOKEN,this._maxValue);
         this._maxLabel.text = "";
         if(_loc4_ && this._simulatedValueTextFormat)
         {
