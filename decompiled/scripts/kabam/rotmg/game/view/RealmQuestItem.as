package kabam.rotmg.game.view
{
   ...
   public class RealmQuestItem extends Sprite
   {
      ...
      private function createDiamond() : void
      {
         ...
         var _loc1_:String = !!this._isComplete?"checkbox_filled":"checkbox_empty";
      ...
      {
         var _loc1_:TextFormat = DefaultLabelFormat.createTextFormat(12,16777215,TextFormatAlign.LEFT,false);
